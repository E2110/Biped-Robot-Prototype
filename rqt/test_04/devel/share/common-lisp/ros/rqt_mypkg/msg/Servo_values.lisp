...
(cl:defmethod cl:initialize-instance :after ((m <Servo_values>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo_values)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rqt_mypkg-msg:<Servo_values> is deprecated: use rqt_mypkg-msg:Servo_values instead.")))

(cl:ensure-generic-function 'Servo1_state-val :lambda-list '(m))
(cl:defmethod Servo1_state-val ((m <Servo_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rqt_mypkg-msg:Servo1_state-val is deprecated.  Use rqt_mypkg-msg:Servo1_state instead.")
  (Servo1_state m))

(cl:ensure-generic-function 'Servo2_state-val :lambda-list '(m))
(cl:defmethod Servo2_state-val ((m <Servo_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rqt_mypkg-msg:Servo2_state-val is deprecated.  Use rqt_mypkg-msg:Servo2_state instead.")
  (Servo2_state m))
