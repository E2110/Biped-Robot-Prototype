...
(cl:defmethod cl:initialize-instance :after ((m <Motor_settings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motor_settings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_subscriber-msg:<Motor_settings> is deprecated: use test_subscriber-msg:Motor_settings instead.")))
...
(cl:defmethod KD-val ((m <Motor_settings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_subscriber-msg:KD-val is deprecated.  Use test_subscriber-msg:KD instead.")
  (KD m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Motor_settings>)))
  ...
  "test_subscriber/Motor_settings")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Motor_settings)))
  "Returns string type for a message object of type 'Motor_settings"
  "test_subscriber/Motor_settings")
