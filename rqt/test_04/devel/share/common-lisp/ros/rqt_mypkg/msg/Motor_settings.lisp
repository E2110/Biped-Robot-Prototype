...
(cl:defmethod cl:initialize-instance :after ((m <Motor_settings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motor_settings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rqt_mypkg-msg:<Motor_settings> is deprecated: use rqt_mypkg-msg:Motor_settings instead.")))
...
(cl:defmethod KD-val ((m <Motor_settings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rqt_mypkg-msg:KD-val is deprecated.  Use rqt_mypkg-msg:KD instead.")
  (KD m))
