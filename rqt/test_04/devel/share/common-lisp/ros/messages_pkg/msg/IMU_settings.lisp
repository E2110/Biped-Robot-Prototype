...
(cl:defmethod cl:initialize-instance :after ((m <IMU_settings>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMU_settings)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages_pkg-msg:<IMU_settings> is deprecated: use messages_pkg-msg:IMU_settings instead.")))
...
(cl:defmethod Ireset-val ((m <IMU_settings>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages_pkg-msg:Ireset-val is deprecated.  Use messages_pkg-msg:Ireset instead.")
  (Ireset m))
