...
(cl:defmethod cl:initialize-instance :after ((m <Motor_values>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motor_values)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name messages_pkg-msg:<Motor_values> is deprecated: use messages_pkg-msg:Motor_values instead.")))

(cl:ensure-generic-function 'motor1_value-val :lambda-list '(m))
(cl:defmethod motor1_value-val ((m <Motor_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages_pkg-msg:motor1_value-val is deprecated.  Use messages_pkg-msg:motor1_value instead.")
  (motor1_value m))

(cl:ensure-generic-function 'motor2_value-val :lambda-list '(m))
(cl:defmethod motor2_value-val ((m <Motor_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages_pkg-msg:motor2_value-val is deprecated.  Use messages_pkg-msg:motor2_value instead.")
  (motor2_value m))

(cl:ensure-generic-function 'OnOff-val :lambda-list '(m))
(cl:defmethod OnOff-val ((m <Motor_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader messages_pkg-msg:OnOff-val is deprecated.  Use messages_pkg-msg:OnOff instead.")
  (OnOff m))
